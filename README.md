...
- **描く** — キャンバスに 1 ストローク描くと 6 軸を抽出し、シニフィアンを生成・発声する。
  **かたちの意味論 4 軸** (size/sharp/texture/bright) + **口のかたち 2 軸** (round/open —
  ...
  「母音+ん」「子音+ん」の最小の語になる。初期プリセットでは、完成したハートは
  **myuun (みゅーん)**、輪郭星または一筆五芒星は **chigyaan (ちぎゃーん)** という
  仮固定語になる。滑らかな花形は星にまとめず、従来の6軸から語を生成する。
...
- **ハート・星の初期プリセット**: 6軸と独立した完成形記述子で、ハート→`myuun`、
  輪郭星/一筆五芒星→`chigyaan` の仮固定語を割り当てる。曖昧な形や滑らかな花形は
  固定語にせず、従来の6軸生成へ戻す。
